...
export interface UploadOptions {
   ...
   * @example ".mp4,.webm,video/mp4" or "video/*"
   */
  accept: string
  /**
...
const VideoIcon: React.FC = () => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M2 6C2 4.34315 3.34315 3 5 3H15C16.6569 3 18 4.34315 18 6V7.38197L20.2111 6.27639C21.089 5.83746 22.15 6.47051 22.15 7.45V16.55C22.15 17.5295 21.089 18.1625 20.2111 17.7236L18 16.618V18C18 19.6569 16.6569 21 15 21H5C3.34315 21 2 19.6569 2 18V6ZM18 14.382L20.15 15.457V8.54296L18 9.61803V14.382ZM16 6V18C16 18.5523 15.5523 19 15 19H5C4.44772 19 4 18.5523 4 18V6C4 5.44772 4.44772 5 5 5H15C15.5523 5 16 5.44772 16 6Z"
      fill="currentColor"
    />
  </svg>
)
...
const DropZoneContent: React.FC<{ maxSize: number; limit: number }> = ({
  ...
  <>
    ...
    <div className="tiptap-video-upload-content">
      ...
      <span className="tiptap-video-upload-subtext">
        Maximum {limit} video{limit === 1 ? "" : "s"}, {maxSize / 1024 / 1024}MB
        each.
      </span>
    </div>
  </>
        ...
        <div className="tiptap-video-upload-previews">
          {fileItems.length > 1 && (
            <div className="tiptap-video-upload-header">
              <span>Uploading {fileItems.length} videos</span>
              <Button
                type="button"
                data-style="ghost"
                onClick={(e) => {
