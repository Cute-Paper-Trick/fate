...
export const v1CommentInfoReplyTargetTypeEnum = {
    "article": "article",
    "comment": "comment"
} as const;

export type V1CommentInfoReplyTargetTypeEnumKey = (typeof v1CommentInfoReplyTargetTypeEnum)[keyof typeof v1CommentInfoReplyTargetTypeEnum];

export type V1CommentInfoReply = {
    /**
     * @description 回复ID
     * @type integer, int64
    */
    ...
    */
    target_type: V1CommentInfoReplyTargetTypeEnumKey;
    /**
     * @description 父评论ID
     * @type integer, int64
    */
