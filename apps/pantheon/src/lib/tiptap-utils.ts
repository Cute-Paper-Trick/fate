...
//   return 'https://goood-space-assets.oss-cn-beijing.aliyuncs.com/public/test/temp/2025-11-10_103052_807.mp4';
//   // Validate file
//   if (!file) {
...
//     throw new Error(`File size exceeds maximum allowed (${MAX_VIDEO_FILE_SIZE / (1024 * 1024)}MB)`);
//   }
...
//   return '/videos/tiptap-ui-placeholder-video.mp4';
// };
...
//   return 'https://goood-space-assets.oss-cn-beijing.aliyuncs.com/public/test/temp/0e459249-b682-4bac-9ac6-ba621e87575a.jpg';
//   // Validate file
//   if (!file) {
//     throw new Error('No file provided');
//   }
...
//  * @param onProgress Optional callback for tracking upload progress
//  * @param abortSignal Optional AbortSignal for cancelling the upload
//  * @returns Promise resolving to the URL of the uploaded audio
//  */
...
//   // For demo/testing: Return a sample audio URL
...
//     throw new Error(`File size exceeds maximum allowed (${MAX_AUDIO_FILE_SIZE / (1024 * 1024)}MB)`);
//   }
